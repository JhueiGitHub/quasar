...
const VibeHole: React.FC = () => {
  useEffect(() => {
    ...
    style.textContent = `
      ...
      .vibeholder-container {
        ...
        place-items: center;
        overflow: visible;
        background-image: radial-gradient(circle at top, #26004d 45%, #6b00d6 55%, #06000d 70%);
        border-radius: 50%;
      }
  ...
  return (
    <div className="vibeholder-container">
